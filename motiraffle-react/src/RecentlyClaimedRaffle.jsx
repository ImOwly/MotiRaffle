...
export const RecentClaimedRaffle = () => {
  ...
  return (
    <div className='flex flex-col bg-[#27282b] mr-[50px] pl-[70px] pr-[70px] rounded-md'>
          ...
          {raffleList.map((items) => (
              <li className='text-white text-opacity-85 pr-[60px] pt-1 list-none max-w-[200px] truncate' key={items.name}>{items.name}</li>
          ))}
