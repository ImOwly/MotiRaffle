  ...
  return (
    <div className='text-white'>
        <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            <p className='text-indigo-500 font-bold p-2 md:text-[40px] sm: text-[30px] text-[20px]'>MotiRaffle</p>
            ...
            <div className='md-text-2xl text-xl'>
                <button className='bg-indigo-500 w-[150px] rounded-md font-medium my-6 mx-auto py-3'>
